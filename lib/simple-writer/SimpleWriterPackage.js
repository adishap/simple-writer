import {
  BasePackage, StrongPackage, EmphasisPackage, LinkPackage, Document, ImagePackage,
  ParagraphPackage, HeadingPackage, CodeblockPackage, SwitchTextTypePackage, SuperscriptPackage
} from 'substance'

import BodyPackage from '../body/BodyPackage'
import HighlightPackage from '../highlight/HighlightPackage'
import FancyParagraphPackage from '../fancy-paragraph/FancyParagraphPackage'
